                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="use_times"
                                   value="{{ old('use_times', $productCoupon->use_times) }}" class="form-control">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="greater_than"
                                   value="{{ old('greater_than', $productCoupon->greater_than, $productCoupon->status) }}"
                                   class="form-control">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option
                                    value="1" {{ old('status', $productCoupon->status) == '1' ? 'selected' : null }}>
                                    Active
                                </option>
                                <option
                                    value="0" {{ old('status', $productCoupon->status) == '0' ? 'selected' : null }}>
                                    Inactive
                                </option>
                            </select>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control"
                                      rows="3">{{ old('description', $productCoupon->description) }}</textarea>
