...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit review on
                product {{ $productReview->product->name }}</h6>
            <div class="ml-auto">
            ...
            <form action="{{ route('admin.product_reviews.update', $productReview->id) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text"
                               {{--value="{{ $productReview->user_id != '' ? $productReview->users->full_name : '' }}"--}}
                               class="form-control" readonly>
                        <input type="hidden" name="user_id" value="{{ $productReview->user_id ?? '' }}"
                               class="form-control" readonly>
