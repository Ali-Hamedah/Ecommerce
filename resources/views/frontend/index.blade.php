        ...
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                <a class="category-item" href="{{ route('frontend.shop', $product_categories[0]->slug) }}">
                    <img class="img-fluid"
                         src="{{ asset('assets/product_categories/cat-img-1.jpg') }}" alt="">
            ...
            <div class="col-md-4">
                <a class="category-item" href="{{ route('frontend.shop', $product_categories[3]->slug) }}">
                    <img class="img-fluid"
                         src="{{ asset('assets/product_categories/cat-img-4.jpg') }}" alt="">
