...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // CUSTOMER
        $manageCustomer = Permission::create(['name' => 'manage_customers', 'display_name' => 'Customers', 'route' => 'customers', 'module' => 'customers', 'as' => 'customers.index', 'icon' => 'fas fa-user', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '25',]);
        $manageCustomer->parent_show = $manageCustomer->id;
        $manageCustomer->save();
        $showCustomer = Permission::create(['name' => 'show_customers', 'display_name' => 'Customer', 'route' => 'customers', 'module' => 'customers', 'as' => 'customers.index', 'icon' => 'fas fa-comment', 'parent' => $manageCustomer->id, 'parent_original' => $manageCustomer->id, 'parent_show' => $manageCustomer->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createCustomer = Permission::create(['name' => 'create_customers', 'display_name' => 'Create Customers', 'route' => 'customers', 'module' => 'customers', 'as' => 'customers.create', 'icon' => null, 'parent' => $manageCustomer->id, 'parent_original' => $manageCustomer->id, 'parent_show' => $manageCustomer->id, 'sidebar_link' => '1', 'appear' => '0']);
        $displayCustomer = Permission::create(['name' => 'display_customers', 'display_name' => 'Show Customers', 'route' => 'customers', 'module' => 'customers', 'as' => 'customers.show', 'icon' => null, 'parent' => $manageCustomer->id, 'parent_original' => $manageCustomer->id, 'parent_show' => $manageCustomer->id, 'sidebar_link' => '1', 'appear' => '0']);
        $updateCustomer = Permission::create(['name' => 'update_customers', 'display_name' => 'Update Customers', 'route' => 'customers', 'module' => 'customers', 'as' => 'customers.edit', 'icon' => null, 'parent' => $manageCustomer->id, 'parent_original' => $manageCustomer->id, 'parent_show' => $manageCustomer->id, 'sidebar_link' => '1', 'appear' => '0']);
        $deleteCustomer = Permission::create(['name' => 'delete_customers', 'display_name' => 'Delete Customers', 'route' => 'customers', 'module' => 'customers', 'as' => 'customers.destroy', 'icon' => null, 'parent' => $manageCustomer->id, 'parent_original' => $manageCustomer->id, 'parent_show' => $manageCustomer->id, 'sidebar_link' => '1', 'appear' => '0']);

        // SUPERVISOR
        $manageSupervisor = Permission::create(['name' => 'manage_supervisors', 'display_name' => 'supervisors', 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.index', 'icon' => 'fas fa-user', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '0', 'appear' => '1', 'ordering' => '25',]);
        $manageSupervisor->parent_show = $manageSupervisor->id;
        $manageSupervisor->save();
        $showSupervisor = Permission::create(['name' => 'show_supervisors', 'display_name' => 'Supervisors', 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.index', 'icon' => 'fas fa-comment', 'parent' => $manageSupervisor->id, 'parent_original' => $manageSupervisor->id, 'parent_show' => $manageSupervisor->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createSupervisor = Permission::create(['name' => 'create_supervisors', 'display_name' => 'Create Supervisors', 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.create', 'icon' => null, 'parent' => $manageSupervisor->id, 'parent_original' => $manageSupervisor->id, 'parent_show' => $manageSupervisor->id, 'sidebar_link' => '1', 'appear' => '0']);
        $displaySupervisor = Permission::create(['name' => 'display_supervisors', 'display_name' => 'Show Supervisors', 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.show', 'icon' => null, 'parent' => $manageSupervisor->id, 'parent_original' => $manageSupervisor->id, 'parent_show' => $manageSupervisor->id, 'sidebar_link' => '1', 'appear' => '0']);
        $updateSupervisor = Permission::create(['name' => 'update_supervisors', 'display_name' => 'Update Supervisors', 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.edit', 'icon' => null, 'parent' => $manageSupervisor->id, 'parent_original' => $manageSupervisor->id, 'parent_show' => $manageSupervisor->id, 'sidebar_link' => '1', 'appear' => '0']);
        $deleteSupervisor = Permission::create(['name' => 'delete_supervisors', 'display_name' => 'Delete Supervisors', 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.destroy', 'icon' => null, 'parent' => $manageSupervisor->id, 'parent_original' => $manageSupervisor->id, 'parent_show' => $manageSupervisor->id, 'sidebar_link' => '1', 'appear' => '0']);
